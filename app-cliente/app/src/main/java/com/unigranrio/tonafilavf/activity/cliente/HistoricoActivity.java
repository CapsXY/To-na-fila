...
public class HistoricoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("TôNaFila! - Histórico");
    ...
    public void excluirMovimentacao(final RecyclerView.ViewHolder viewHolder) {
        ...
        alertDialog.setMessage("Você  deseja excluir o registro?");
        ...
        alertDialog.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(HistoricoActivity.this, "Cancelado", Toast.LENGTH_SHORT).show();
    ...
    private void inicializarComponentes() {
        recyclerViewSolicitacoes = findViewById(R.id.recyclerViewHistorico);
    }
}